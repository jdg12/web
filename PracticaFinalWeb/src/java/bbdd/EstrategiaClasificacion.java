 ...
 * @author JD
 */
public class EstrategiaClasificacion implements Estrategia{
    @Override
    public void ordena(ArrayList<Pelicula> peliculas) {
        ...
        Comparator AnoComp = new Comparator() {
            ...
            public int compare(Object o1, Object o2) {
                ...
                if (peli1.getClasificacion() == peli2.getClasificacion()) {
                    return 0;
                } else if (peli1.getClasificacion() < peli2.getClasificacion()) {
                    return -1;
                } else {
                    return +1;
                }
