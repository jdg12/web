...
<html>
	...
	<div class="linea">
        ...
        <form action="/PracticaFinalWeb/modificarSala">
            ...
            <br /><label>Filas: </label><br><input id="filas" type="number" name="filas"  autofocus required/>
            <br /><label>Columnas: </label><br><input id="columnas" type="number" name="columnas"  autofocus required/>
            <input type="hidden" id="thisField" name="inputName" value="anadir">
            <br /><br><input class="boton" type="submit" value="Añadir">
        </form>
                        <!--
